...
import { callLogoutUserApi, createChatApi } from '../services/api_services.js'
                    ...
                    return (
                      <div key={chat.id} onClick={() => { navigate(`/main/chat/${chat.id}`); setIsMenuOpen(false) }} className='p-2 px-4 dark:bg-[#57317C]/10 border border-black-800 dark:border-[#80609F]/15 rounded-md cursor-pointer flex items-center justify-between group'>
                        ...
                        <div className='flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity' onClick={(e) => e.stopPropagation()}>
                          <button className='text-gray-500 hover:text-blue-500 dark:text-gray-400 dark:hover:text-blue-400 transition-colors' title="Edit chat">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 20h9"/><path d="M16.5 3.5a2.12 2.12 0 0 1 3 3L7 19l-4 1 1-4Z"/></svg>
                          </button>
                          <button className='text-gray-500 hover:text-red-500 dark:text-gray-400 dark:hover:text-red-400 transition-colors' title="Delete chat">
